...
public class Drive extends SubsystemBase {
  ...
  private SwerveDriveKinematics kinematics =
      new SwerveDriveKinematics(Constants.Drive.moduleTranslations);
  ...
  public void stopWithX() {
    ...
    for (int i = 0; i < 4; i++) {
      headings[i] = Constants.Drive.moduleTranslations[i].getAngle();
    }
  ...
  /** Resets the current yaw to zero. */
